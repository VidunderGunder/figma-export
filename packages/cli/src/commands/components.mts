...
import { asArray, requirePackages } from '../utils.mjs';
    ...
    .action(
        async (fileId, {
            ...
            figmaExport.components({
                ...
                onlyFromPages: page,
                transformers: await Promise.all(requirePackages<FigmaExport.StringTransformer>(transformer)),
                outputters: await Promise.all(requirePackages<FigmaExport.ComponentOutputter>(outputter, { output })),
